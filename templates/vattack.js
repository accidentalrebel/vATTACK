<script type="text/javascript">
    function show_plot(is_tools_visible, is_groups_visible, is_mitigations_visible, is_malware_visible, is_subtechniques_visible) {
	if ( is_tools_visible == null )
	    is_tools_visible = "False";
 	if ( is_groups_visible == null )
	    is_groups_visible = "False";
	if ( is_subtechniques_visible == null )
	    is_subtechniques_visible = "False";
	...
	$.ajax({
		...
		is_subtechniques_visible: is_subtechniques_visible,
